...
# setup() and tearDown() are special methods that get run before and after every
# test, so they're a bit like
...
class NewVisitorTest(StaticLiveServerTestCase):
    ...
    # methods that begin with "test_" are treated as tests to be run the by
    # unittest runner ( unittest.main() )
